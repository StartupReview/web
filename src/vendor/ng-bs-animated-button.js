  ...
  angular.module('ng-bs-animated-button', []).directive('ngBsAnimatedButton', [
    ...
    function($timeout) {
      return {
        ...
        template: '<button type="submit" class="btn {{buttonClass}} {{buttonSize}} btn-ng-bs-animated clearfix" ng-disabled="{{formIsInvalid}}">' +
          '<div class="icons pull-{{iconsPosition}}">' +
          '<span class="{{buttonDefaultIcon}} icon-spinner icon-default hidden"></span>' +
